...
public class SimpleParser implements JmmParser {
    ...
    public JmmParserResult parse(String jmmCode, String startingRule, Map<String, String> config) {
        ...
        try {
            ...
            // The class JavammParser generated by ANTLR contains a method getNumberOfSyntaxErrors,
            //which can be used after the parsing occurs to determine how many syntax errors happened. If there
            ...
            return AntlrParser.parse(lex, parser, startingRule)
                    ...
                    .orElseGet(() -> JmmParserResult.newError(new Report(ReportType.ERROR, Stage.LEXICAL, -1,
                            "There were " + parser.getNumberOfSyntaxErrors() + " syntax errors during parsing, terminating")));
